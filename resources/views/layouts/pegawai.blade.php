    ...
    <!-- <div class="row p-0 m-0 proBanner" id="proBanner">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items {{ request()->segment(1) === 'pegawai' ? 'active' : '' }}">
          ...
          <li class="nav-item menu-items {{ request()->segment(1) === 'profile' ? 'active' : '' }}">
          ...
          <li class="nav-item menu-items {{ in_array(request()->segment(1), ['datalowonganpekerjaan', 'tambahlowongan', 'tahap', 'editlowongan']) ? 'active' : '' }}">
            <a class="nav-link {{ in_array(request()->segment(1), ['datalowonganpekerjaan', 'tambahlowongan', 'tahap', 'editlowongan']) ? 'active' : '' }}" href="{{ url('/datalowonganpekerjaan') }}">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items {{ in_array(request()->segment(1), ['manajkandidat', 'detailkandidat-pegawai']) ? 'active' : ''  }}">
            <a class="nav-link {{ in_array(request()->segment(1), ['manajkandidat', 'detailkandidat-pegawai']) ? 'active' : ''  }}" href="{{ url('/manajkandidat') }}">
              <span class="menu-icon">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="dashmin/images/logo-mini.svg" alt="logo" /></a>
          </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                    <a id="profileLink" class="dropdown-item preview-item " href="profile">
                      <span class="menu-icon">
