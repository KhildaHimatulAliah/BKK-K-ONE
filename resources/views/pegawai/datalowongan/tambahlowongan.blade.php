...
<div class="col-md-15 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <hr>
        <form class="forms-sample"  action="/insertlowonganpeg" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="textarea" class="textEditor" id="deskripsi" name="deskripsi" placeholder="Ketik disini....">
            </div>
          </div>
          <div class="form-group row">
            <label for="keahlian" class="col-sm-3 col-form-label">Keahlian Yang Harus Dimiliki</label>
            <div class="col-sm-9">
              <input type="textarea" class="textEditor" id="keahlian" name="keahlian" placeholder="Ketik disini....">
            </div>
          </div>
          <div class="form-group row">
            <label for="kualifikasi" class="col-sm-3 col-form-label">Kualifikasi</label>
            <div class="col-sm-9">
              <input type="textarea" class="textEditor" id="kualifikasi" name="kualifikasi" placeholder="Ketik disini....">
            </div>
          </div>
          <div class="form-group row">
            <label for="informasi_lainya" class="col-sm-3 col-form-label">Informasi Lainya</label>
            <div class="col-sm-9">
              <input type="textarea" class="textEditor" id="informasi_lainya" name="informasi_lainnya" placeholder="Ketik disini....">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="alamat" placeholder="Alamat Perusahaan" style="background-color: black" disabled>
            </div>
          </div>
          <div class="form-group row">
            <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Detail Perusahaan</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="detail" placeholder="Detail Perusahaan" style="background-color: black" disabled>
            </div>
          </div>
          <div class="form-group row">
            <label for="batas_pelamar" class="col-sm-3 col-form-label">Batas Pelamar:</label>
            <div class="col-sm-9">
            <input type="number" class="form-control" id="batas_pelamar" name="batas_pelamar" min="1" value="1">
          </div>
          </div>
