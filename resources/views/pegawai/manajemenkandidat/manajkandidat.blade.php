...
<div class="card">
<div class="card-body">
<h4 class="card-title">MANAJEMEN KANDIDAT</h4>
      ...
      <table class="table table-striped">
        ...
        <tbody>
          <tr >
            ...
            <td style="color: white">
              <a href="detailkandidat-pegawai/{{ $l->id }}" class=" mdi mdi-account-details btn btn-outline-info " style="font-size: 10px;"> DETAIL</a>
            </td>
          </tr>
          @endforeach
        </tbody>
