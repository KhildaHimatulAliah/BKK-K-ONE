                ...
                <div class="card-body">
                  ...
                  <form action="/tambahdata" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="file" name="logo" class="form-control" id="gambar" value="" style="color: white">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Nama Perusahaan</label>
                      <div class="col-sm-9">
                        <input type="text" name="nama" class="form-control" id="judul" value="" style="color: white">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Alamat</label>
                      <div class="col-sm-9">
                        <input type="text" name="alamat" class="form-control" id="judul" value="" style="color: white">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Detail Perusahaan</label>
                      <div class="col-sm-9">
                        <input type="textarea" name="detail" class="textarea" id="deskr" placeholder="Ketik disini...." value="" style="color: white">
                      </div>
                    </div>
