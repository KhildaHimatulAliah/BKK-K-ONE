            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <hr>
                  <form action="/newartikel/{{ $artikel->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="file" name="foto" class="form-control" id="foto" value="{{ $artikel->foto }}">
                        </div>
                      </div>
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Deskripsi</label>
                      <div class="col-sm-9">
                        <input type="textarea" name="deskripsi" class="textarea" id="deskripsi" value="{{ $artikel->deskripsi }}">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Waktu</label>
                      <div class="col-sm-9">
                        <input type="text" name="tahap_1" class="form-control" id="tahap_1" value="{{ $artikel->created_at }}">
                      </div>
                    </div>
