...
<div class="row">
  ...
  <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Edit NIS</h4>
          @if (session('success'))
                  ...
                  @endif
                    ...
                    @endif
          <form action="/updatenis/{{ $nis->id }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-group row">
              <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Nama</label>
              <div class="col-sm-9">
                <input type="text" name="nama" class="form-control" id="nama" value="{{ $nis->nama }}" style="color: white">
              </div>
            </div>
            <div class="form-group row">
              <label for="exampleInputEmail2" class="col-sm-3 col-form-label">No Induk Siswa (NIS)</label>
              <div class="col-sm-9">
                <input type="text" name="nis" class="form-control" id="nis" value="{{ $nis->nis }}" style="color: white">
              </div>
            </div>
