...
<div class="col-md-15 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <hr>
        <form class="forms-sample" action="{{ route('tambahTahapan', ['id_lowongan' => request()->id_lowongan]) }}" method="post">
            @csrf
            <div class="d-flex justify-content-between mb-2">
                <button id="tambahTahapan" class="btn btn-outline-primary mdi mdi-plus">Tahap</button>                
            </div>
            <div class="mb-2" id="containerTahapan">
              <!-- Input tahapan pertama di sini -->
              <div class="input-group">
                  <input type="text" name="name[]" class="form-control mb-2" placeholder="Tahap 1" style="color: white">
