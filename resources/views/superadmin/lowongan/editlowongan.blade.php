...
<div class="col-md-15 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <hr>
        <form class="forms-sample"  action="/updatelowongan/{{ $lowongan->id }}" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="textarea" class="textarea" id="deskripsi" name="deskripsi" placeholder="Ketik disini...." value="{{ $lowongan->deskripsi }}">
            </div>
          </div>
          <div class="form-group row">
            <label for="keahlian" class="col-sm-3 col-form-label">Keahlian Yang Harus Dimiliki</label>
            <div class="col-sm-9">
              <input type="textarea" class="textarea" id="keahlian" name="keahlian" placeholder="Ketik disini...." value="{{ $lowongan->keahlian }}">
            </div>
          </div>
          <div class="form-group row">
            <label for="kualifikasi" class="col-sm-3 col-form-label">Kualifikasi</label>
            <div class="col-sm-9">
              <input type="textarea" class="textarea" id="kualifikasi" name="kualifikasi" placeholder="Ketik disini...." value="{{ $lowongan->kualifikasi }}">
            </div>
          </div>
          <div class="form-group row">
            <label for="informasi_lainya" class="col-sm-3 col-form-label">Informasi Lainya</label>
            <div class="col-sm-9">
              <input type="textarea" class="textarea" id="informasi_lainya" name="informasi_lainnya" placeholder="Ketik disini...." value="{{ $lowongan->informasi_lainnya }}">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="date" class="form-control" id="tanggal_dimulai" name="tanggal_dimulai" value="{{ $lowongan->tanggal_dimulai }}" placeholder="Awal Pendaftaran">
            </div>
          </div>
          <div class="form-group row">
            <label for="tanggal_berakhir" class="col-sm-3 col-form-label">Akhir Pendaftaran</label>
            <div class="col-sm-9">
              <input type="date" class="form-control" id="tanggal_berakhir" name="tanggal_berakhir" value="{{ $lowongan->tanggal_berakhir }}" placeholder="Akhir Pendaftaran" >
            </div>
          </div>
          <div class="form-group row">
