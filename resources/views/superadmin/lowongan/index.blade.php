                    ...
                    <div class="col-auto ms-auto">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuOutlineButton1">
                              ...
                              <a class="dropdown-item" href="{{ route('datalowongan') }}">Semua</a>
                              <a class="dropdown-item" href="{{ route('datalowongan', ['status' => 'aktif']) }}">Aktif</a>
                              <a class="dropdown-item" href="{{ route('datalowongan', ['status' => 'kadaluwarsa']) }}">Kadaluwarsa</a>
                          </div>
                        </div>
                    </div>
                    <div class="col-auto">
                        <a href="/tambahlowongan" class="btn btn-outline-primary btn-fw d-flex align-items-center" style="font-size: 11px">
