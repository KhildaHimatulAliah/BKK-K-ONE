...
class PegawaiController extends Controller
{
    public function index() {
        ...
        return view('pegawai.dashboardpegawai', ['count_perusahaan' => $count_perusahaan, 'label_jk' => $label_jk, 'jml_jk' => $jml_jk, 'count_kandidat' => $count_kandidat, 'count_lowongan' => $count_lowongan, 'lowongan' => $lowongan, 'kandidat_diterima' => $kandidat_diterima, 'label_low' => $label_low, 'jml_low'=>$jml_low, 'label_jur'=>$label_jur, 'jml_jur'=>$jml_jur]);
    }


    public function profilesaya() {
        return view('pegawai.profile.profilesaya');
    }
    ...
    public function simpanGambar(Request $request)
    {
        ...
        return redirect('profile')->with('berhasil', 'Berhasil di Edit!');
    }
